...
SEASONAL_HYSTERESIS = 0.5       # C band around each threshold to prevent flapping

# entry.options keys for the smart-feature step.
OPT_OUTDOOR_SOURCE  = "outdoor_source"
